...
manager
  .startWatching({
    kindsToWatch: [
      {
        kind: new HorizontalVerticalElasticityStrategyKind(),
        controller: new HorizontalVerticalElasticityStrategyController(
          polarisRuntime
        ),
      },
    ],
