...
import { HorizontalElasticityStrategyConfig } from '@nicokratky/elasticity-strategies';
...
> {
  protected computeScale(
    ...
    const multiplier =
      elasticityStrategy.spec.sloOutputParams.currSloCompliancePercentage / 100;
